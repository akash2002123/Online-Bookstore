...
/**
 * Aspect for logging execution of service methods in the OrderService. 
 * Uses Spring AOP.
 */
@Aspect
@Component
public class LoggingAspect {
	...
	public void logBefore(JoinPoint joinPoint) {
		logger.info("A method in OrderService is about to be executed. Method: " + joinPoint.getSignature().getName()
	...
	public void logAfterReturning(JoinPoint joinPoint, Object result) {
		logger.info("A method in OrderService has executed successfully. Method: " + joinPoint.getSignature().getName()
				+ ", Result: " + result);
	}
	...
	public void logAfterThrowing(JoinPoint joinPoint, Throwable error) {
		logger.error("An error occurred in OrderService. Method: " + joinPoint.getSignature().getName() + ", Error: "
				+ error.getMessage());
	}
}
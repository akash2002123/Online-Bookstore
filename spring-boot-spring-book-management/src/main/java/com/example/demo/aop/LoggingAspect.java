...
public class LoggingAspect {
	...
	/**
	 * Pointcut that matches all methods in the BookServiceImpl class.
	 */
	@Pointcut("execution(* com.example.demo.service.BookServiceImpl.*(..))")
	public void serviceMethods() {
		// Pointcut for methods in BookServiceImpl
	}
